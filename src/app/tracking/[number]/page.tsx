...
export default function TrackingPage() {
  ...
  useEffect(() => {
    if (params.number) {
      setTrackingNumber(params.number as string);
      fetchTracking(params.number as string);
    }
  }, [params.number]);
  ...
  function handleSearch(e: React.FormEvent) {
    ...
    if (trackingNumber.trim()) {
      window.history.replaceState(null, "", `/tracking/${encodeURIComponent(trackingNumber.trim())}`);
