            ...
            {[
              ...
              },
              {
                icon: (
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
                      d="M23 4.6C22.2 5 21.3 5.2 20.4 5.3C21.4 4.7 22.1 3.7 22.5 2.5C21.6 3 20.6 3.4 19.4 3.6C18.6 2.7 17.4 2 16 2C13.4 2 11.3 4.1 11.3 6.7C11.3 7.1 11.3 7.4 11.4 7.7C7.7 7.6 4.5 5.7 2.4 2.8C2 3.4 1.7 4.2 1.7 5C1.7 6.6 2.5 8 3.8 8.8C3.1 8.8 2.4 8.6 1.8 8.3C1.8 10.6 3.4 12.5 5.6 12.9C5.2 13 4.8 13.1 4.4 13.1C4.1 13.1 3.8 13 3.5 12.9C4.1 14.8 5.9 16.1 8 16.1C6.4 17.4 4.4 18.2 2.2 18.2C1.8 18.2 1.4 18.2 1 18.1C3.1 19.4 5.6 20 8.2 20C16 20 20.2 13.5 20.2 7.9C20.2 7.7 20.2 7.5 20.2 7.3C21.1 6.6 21.9 5.8 22.5 4.9L23 4.6Z"
                      fill="#0a47c9"
                    />
                  </svg>
                ),
